(self["webpackChunkregistroApp"] = self["webpackChunkregistroApp"] || []).push([["common"],{
...
let AlumnosService = class AlumnosService {
    constructor(cliente) {
        ...
        this.API = "https://registraapp.herokuapp.com/alumnos";
    }
    getAll() {
        //retornando api
        return this.cliente.get(this.API);
    }
    createAlumno(nombre, apellido, run, estado, carrera, seccion, sede, correo, telefono, dv) {
...
AlumnosService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
let UsersService = class UsersService {
    constructor(cliente) {
        this.cliente = cliente;
        this.API = "https://registraapp.herokuapp.com/usuarios";
    }
    getAll() {
        //retornando api
        return this.cliente.get(this.API);
    }
    createUser(nombre, contrasenia, estado) {
